...
# Nov 2018: Dado added AWS_ACCESS_KEY_ID and AWS_SECRET_ACCESS_KEY to 
# be passed as paramters as sometimes grabbing KEYS from build pipelines
# rather than shell env variable is more practical especially with generic
# public containers used for building projects
